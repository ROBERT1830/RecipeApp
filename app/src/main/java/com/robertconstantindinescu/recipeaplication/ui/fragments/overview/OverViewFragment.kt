...
class OverViewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //La variable args apuntará a los argumentos pasados por bundle.
        val args = arguments

        //Obtenemos esos datos del bundle con la clave definida
        //Obtemnemos los datos del bunle usando la clave. Bundle = objeto result.
        val myBundle: Result? = args?.getParcelable(RECIPE_RESULT_KEY)

        //accedemos a las vistas y cargamos el dato correspondiente.
        ...
        /**
         * En todos estos, en función del valor que obtenemos por bundle, pintaremos el icono
         * correspondiente de verde si es true.
         */
